 ...
 * @author jdgom
 */
public class JFVistaCliente extends javax.swing.JFrame {

    /**
     * Creates new form JFVistaCliente
     */
    public JFVistaCliente() {
        initComponents();
        mostrar("");
    ...
    private void TablaHMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaHMousePressed
        if(evt.getClickCount()==2){
            ...
            valor=TablaH.getValueAt(fila, 1).toString()+" "+TablaH.getValueAt(fila, 2).toString()+" "+TablaH.getValueAt(fila, 3).toString();
            
            JFReserva.txtIdC.setText(cod);
            JFReserva.txtNombreC.setText(valor);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFVistaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFVistaCliente().setVisible(true);
            }
        });
    }
